...
namespace Abc.Tests.Pages {
    ...
    public abstract class AbstractPageTests<TClass, TBaseClass> : AbstractClassTests<TClass, TBaseClass>
        where TClass : BasePage<IMeasureRepository, Measure, MeasureView, MeasureData> {

        internal testRepository db; 
        internal class testClass : CommonPage<IMeasureRepository, Measure, MeasureView, MeasureData> {

            protected internal testClass(IMeasureRepository r) : base(r) {
                PageTitle = "Measures";
            }
        ...
        internal class testRepository : baseTestRepositoryForUniqueEntity<Measure, MeasureData>, IMeasureRepository { }
