...
namespace Abc.Tests.Pages {
    ...
    [TestClass]
    public class BasePageTests : AbstractPageTests<BasePage<IMeasureRepository, Measure, MeasureView, MeasureData>,
        PageModel> {
        ...
        [TestMethod] public void GetSearchStringTest() {
            void test(string filter, string searchString, int? pageIndex, bool isFirst) {
                ...
                var actual = BasePage<IMeasureRepository, Measure, MeasureView, MeasureData>.getSearchString(filter, searchString, ref pageIndex);
