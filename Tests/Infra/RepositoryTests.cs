...
{
    [TestClass]
    public abstract class RepositoryTests<TRepository, TObjet, TData> : BaseTests
        where TRepository : IRepository<TObjet>
        where TObjet : Entity<TData>
        where TData : PeriodData, new()
    {
        ...
        protected abstract TObjet getObject(TData d);
